...
namespace DataLayer.Contracts.COM
{
    public interface ICommonDataAccess
    {
        ...
        CollectionResult<GetRoles> GetDropDownRoles(string Connectionstring);
        CollectionResult<GetPartList> GetPartList(string Connectionstring);
